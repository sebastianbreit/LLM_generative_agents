...
A overview of the basic NPC-Agent can be seen in Fig1.
![NPC-Agent](data/npc_agent.png "NPC-Agent")
...
A overview of the transactional NPC-Agent can be seen in Fig2.
